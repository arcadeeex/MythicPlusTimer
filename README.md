...
Также есть возможность кастомизировать стиль и цвета аддона как удобно.

Стили:

![Настройки цветов аддона](screenshots/style-settings.png)
...
- Команды: `/mpt` — окно настроек, `/mpt timer` — показать/скрыть таймер, `/mpt preview` — превью, `/mpt debug` — режим отладки.
